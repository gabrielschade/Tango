...
namespace Tango.Functional
{
    public static class FunctionExtensions
    {
        ...
        public static Func<T2, Func<T3, TResult>> PartialApply<T, T2, T3, TResult>(this Func<T, T2, T3, TResult> function, T parameter)
            => PartialApplication.PartialApply(function, parameter);
        ...
        public static Action<T2> Curry<T, T2>(Action<T, T2> action, T parameter)
            => PartialApplication.PartialApply(action, parameter);

        public static Func<T2, Action<T3>> Curry<T, T2, T3>(Action<T, T2, T3> action, T parameter)
            => PartialApplication.PartialApply(action, parameter);

        public static Action<T3> Curry<T, T2, T3>(Action<T, T2, T3> action, T parameter, T2 parameter2)
